...
<m:top item='5_' name='自动任务' notshowall='1'  display='block' rank='sys_MakeHtml'>
  <m:item name='一键更新PC网站' link='makehtml_all.php' rank='sys_MakeHtml' target='main' />
  <m:item name='一键更新移动网站' link='makehtml_all_m.php' rank='sys_MakeHtml_m' target='main' />
  <m:item name='更新系统缓存' link='sys_cache_up.php' rank='sys_ArcBatch' target='main' />
  {$remoteMenu}
</m:top>
...
<m:top item='5_' name='HTML更新' notshowall='1' display='none' rank='sys_MakeHtml'>
  ...
  <m:item name='更新PC栏目HTML' link='makehtml_list.php' rank='sys_MakeHtml' target='main' />
  <m:item name='更新移动端栏目HTML' link='makehtml_list_m.php' rank='sys_MakeHtml' target='main' />
  <m:item name='更新PC文档HTML' link='makehtml_archives.php' rank='sys_MakeHtml' target='main' />
  <m:item name='更新移动端文档HTML' link='makehtml_archives_m.php' rank='sys_MakeHtml' target='main' />
